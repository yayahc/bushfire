...
file_vegetation=r"./vegetation.csv"
file_climat=r"./climat.csv"
file_eclosion=r"./eclosion.csv"
...
##print(vegetation)
veget1=vegetation['data_veg'].to_numpy()  #choix de la colonne pour lecture
...
##print(climat)
clim=climat['data_clim'].to_numpy()    
...
eclos1=eclosion['data_eclo'].to_numpy()
